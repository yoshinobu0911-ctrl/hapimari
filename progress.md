...
- **PR #1 レビュー対応は統合指摘表42件を基準に管理**（済8・未31・見送り3）。[統合表](docs/review/2026-09-24_統合指摘表.md)・[決済の統一提案](docs/design/2026-09-24_決済修正設計提案.md)を作成済み。決済の追加範囲・退会方式・匿名化の次期設計範囲の確認待ち。実装は未着手。
