...
-- ============================================================
-- M6追記（2026-07-07）: デモ用の初期状態
--   ・男性seedは課金済み扱い（R9でチャットが使えるように）
...
from (values
  ...
  ('00000000-0000-0000-0000-000000000003'::uuid, 35.86, 139.65), -- ひろし: 浦和
  ('00000000-0000-0000-0000-000000000004'::uuid, 35.61, 140.11), -- まさお: 千葉
  ('00000000-0000-0000-0000-000000000005'::uuid, 35.73, 139.71), -- しんじ: 池袋
  ('00000000-0000-0000-0000-000000000006'::uuid, 35.91, 139.62), -- さとる: 大宮
  ('00000000-0000-0000-0000-000000000007'::uuid, 35.69, 139.98), -- のぼる: 船橋
  ('00000000-0000-0000-0000-000000000008'::uuid, 35.66, 139.70), -- おさむ: 渋谷
  ('00000000-0000-0000-0000-000000000009'::uuid, 35.80, 139.71), -- ゆうじ: 川口
  ('00000000-0000-0000-0000-000000000010'::uuid, 35.78, 139.90), -- かずお: 松戸
  ('00000000-0000-0000-0000-000000000011'::uuid, 35.71, 139.79), -- てつや: 上野
  ('00000000-0000-0000-0000-000000000012'::uuid, 35.99, 139.59), -- まこと: 上尾
  ('00000000-0000-0000-0000-000000000013'::uuid, 35.75, 139.80), -- ようこ: 足立
  ('00000000-0000-0000-0000-000000000014'::uuid, 35.86, 139.65), -- さちこ: 浦和
  ('00000000-0000-0000-0000-000000000015'::uuid, 35.69, 139.98), -- みほ: 船橋
  ('00000000-0000-0000-0000-000000000016'::uuid, 35.64, 139.74), -- えみ: 品川
  ('00000000-0000-0000-0000-000000000017'::uuid, 35.91, 139.62), -- かおり: 大宮
  ('00000000-0000-0000-0000-000000000018'::uuid, 35.70, 139.56), -- なおみ: 三鷹
