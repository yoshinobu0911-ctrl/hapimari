...
- **PR #1 レビュー対応は統合指摘表42件を基準に管理**（済8・未31・見送り3）。[統合表](docs/review/2026-09-24_統合指摘表.md)・[決済の統一提案](docs/design/2026-09-24_決済修正設計提案.md)を作成済み。Q1〜Q3 は決定済み（提案書 §8）。次は P1 追補（S）→決済の実装差分提示→承認→実装。
